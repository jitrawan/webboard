...
?>
  ...
  <div class="animationload" style="display: none;">
    ...
    <!--nav class="navbar navbar-expand-lg bg-secondary fixed-top text-uppercase" id="mainNav"-->
      ...
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Kae Tae Kao</a>
    ...
    <section class="portfolio" id="portfolio" style="padding-top: 50px;">
				<?require("portfolo.php");?>
    </section>
    ...
    <!-- Portfolio Modals -->
		...
		<div class="modal portfolio-modal" id="portfolio-modal-1">
        ...
        <div class="container text-center">
				<div class="row">
				  <div class="col-lg-8 mx-auto">
				    ...
				    <img class="img-fluid mb-5" src="../admin/resource/card/thumbs/card1.png" alt="">
    ...
    $( document ).ready(function() {
        //console.log( "document loaded" );
				$('.announce').on('click',function(){
				 ...
				 $('.modal-body').load('portfolo_modal.php?id='+dataString,function(){
		        $('#portfolio-modal-1').modal({show:true});
		    });
		});
		});
