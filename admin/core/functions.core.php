...
function resizeBeanerThumb($imgext,$imgname){
	switch($imgext){
		case "jpg" :
		case "jpeg" : 		$images = "../resource/beaner/images/".$imgname;
											$new_images = "../resource/beaner/thumbs/".$imgname;


							$width=1440; //*** Fix Width & Heigh (Auto caculate) ***//
							$size=GetimageSize($images);
							$height=480;
							$images_orig = ImageCreateFromJPEG($images);
							$photoX = ImagesX($images_orig);
							...
							ImageDestroy($images_fin);
			break;
			case "png" : 	$images = "../resource/beaner/images/".$imgname;
										$new_images = "../resource/beaner/thumbs/".$imgname;
							...
							ImagePNG($images_fin,$new_images);
			break;
			case "gif"	:	$images = "../resource/beaner/images/".$imgname;
										$new_images = "../resource/beaner/thumbs/".$imgname;
							...
							ImageGIF($images_fin,$new_images);
			break;
			default : $images = "../resource/beaner/images/".$imgname;
								$new_images = "../resource/beaner/thumbs/".$imgname;
...
function resizeCardThumb($imgext,$imgname){
	$Folder = "card";
	$setwidth = 900;
	$setheight = 650;
	switch($imgext){
		case "jpg" :
		case "jpeg" : 		$images = "../resource/$Folder/images/".$imgname;
											$new_images = "../resource/$Folder/thumbs/".$imgname;


							$width=$setwidth; //*** Fix Width & Heigh (Auto caculate) ***//
							$size=GetimageSize($images);
							$height=$setheight;
							$images_orig = ImageCreateFromJPEG($images);
							$photoX = ImagesX($images_orig);
							...
							ImageDestroy($images_fin);
			break;
			case "png" : 	$images = "../resource/$Folder/images/".$imgname;
										$new_images = "../resource/$Folder/thumbs/".$imgname;
							...
							ImagePNG($images_fin,$new_images);
			break;
			case "gif"	:	$images = "../resource/$Folder/images/".$imgname;
										$new_images = "../resource/$Folder/thumbs/".$imgname;
							...
							ImageGIF($images_fin,$new_images);
			break;
			default : $images = "../resource/$Folder/images/".$imgname;
								$new_images = "../resource/$Folder/thumbs/".$imgname;
...
function deleteFile($imgname,$pathimg){
	$images = "../resource/$pathimg/images/".$imgname;
	$new_images = "../resource/$pathimg/thumbs/".$imgname;
$getresult = FALSE;
if (!unlink($images)){
  $getresult = FALSE;
  }else{
		if (!unlink($new_images)){
	  $getresult = FALSE;
	  }else{
	  $getresult = true;
	  }
