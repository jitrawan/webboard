...
<div class="row">
     <div class="col-lg-12">
             <h1 class="page-header"><i class="fa fa-info-circle fa-fw"></i> จัดการ Card Info </h1>
     </div>
</div>
<ol class="breadcrumb">
  <li><a href="index.php"><?php echo @LA_MN_HOME;?></a></li>
   <li><a href="?p=setting"><?php echo @LA_LB_SETTING;?></a></li>
  <li class="active">จัดการ Card Info</li>
</ol>
...
<!--a href="?p=setting_slider_insert" class="btn btn-primary btn-sm"><i class="fa fa-plus fa-fw"></i> เพิ่มImg Slid </a><br/><br/-->
 <div class="panel panel-default">
  ...
  <?php
  $x=0;
  $getcat = $getdata->my_sql_select(NULL,"All_IMG","img_type = 'card' ");
  ...
  <tr id="<?php echo @$showcat->id;?>">
    ...
    <td align="center" valign="middle">
	  ...
	  ?><a href="?p=setting_card_insert&id=<?php echo @$showcat->id;?>" class="btn btn-xs btn-info" style="color:#FFF;"><i class="fa fa-edit fa-fw"></i> <?php echo @LA_BTN_EDIT;?></a></td>
  </tr>
  <?php
  }
  ?>
