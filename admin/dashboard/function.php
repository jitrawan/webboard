...
$getdata->my_sql_set_utf8();
	switch(addslashes($_GET['type'])){
		...
		break;
		case "change_slider_status" : if(addslashes($_GET['sts']) == "1"){
										$getdata->my_sql_update("All_IMG","img_status='0'","id='".addslashes($_GET['key'])."'");
									}else{
										$getdata->my_sql_update("All_IMG","img_status='1'","id='".addslashes($_GET['key'])."'");
									}
